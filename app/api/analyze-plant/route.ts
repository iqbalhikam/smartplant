...
export async function POST(req: NextRequest) {
  try {
    ...
    const { tanah, cahaya, pompa, lampu, mode, batasKering, batasBasah } = body;
...
1. Berikan analisis singkat tentang kesehatan tanaman saat ini dan rekomendasi tindakan/penyiraman selanjutnya.
