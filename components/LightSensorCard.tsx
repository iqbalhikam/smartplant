...
export default function LightSensorCard({ telemetry }: LightSensorCardProps) {
  return (
    <motion.div
      ...
      className="bg-slate-900/40 border border-slate-800/80 backdrop-blur-xl rounded-2xl p-6 shadow-xl flex flex-col justify-between h-[180px] hover:border-slate-700/80 transition-all duration-300 relative overflow-hidden group"
    >
      ...
      <div className="flex items-center justify-between">
        <span className="text-xs font-bold uppercase tracking-wider text-slate-400">Sensor Cahaya</span>
      ...
      <div className="flex items-center gap-5 my-2">
        {telemetry.cahaya === 1 ? (
          ...
          <>
            ...
            <div>
              <div className="text-2xl font-black text-amber-300 tracking-wide uppercase">TERANG</div>
              <div className="text-[11px] text-slate-400 font-medium">Lampu UV otomatis mati.</div>
            </div>
          </>
        ) : (
          /* Moon / Dark Status */
          <>
            ...
            <div>
              <div className="text-2xl font-black text-indigo-300 tracking-wide uppercase">GELAP</div>
              <div className="text-[11px] text-slate-400 font-medium">Lampu UV siap diaktifkan.</div>
            </div>
          </>
        )}
      </div>

      <div className="text-[10px] text-slate-500 font-mono flex items-center gap-1.5 border-t border-slate-800/80 pt-2.5">
